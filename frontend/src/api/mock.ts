  ...
  entries: [
    {
      ...
      formula_version: "1.0",
      inputs: [
        { input_key: "营业收入", kind: "EXTERNAL_FACT", value: "1000000.00", input_sha256: "aaaa" },
        { input_key: "OCF", kind: "EXTERNAL_FACT", value: "100000.00", input_sha256: "bbbb" },
      ],
      result: "100000.00",
      result_sha256: "cccc",
      unit: "CNY_million",
    },
    {
      ...
      formula_version: "1.0",
      inputs: [
        { input_key: "FCFF", kind: "DERIVED", value: "100000.00", input_sha256: "cccc" },
        { input_key: "净负债", kind: "EXTERNAL_FACT", value: "10000.00", input_sha256: "dddd" },
      ],
      result: "100000.00",
      result_sha256: "eeee",
      unit: "CNY_million",
  ...
  nodes: [
    {
      node_type: "F",
      ref_id: "C-001",
      rendered_value: "2026 年营业收入 1000000 万元（合并，占位）",
      materiality: "MATERIAL",
      evidence_refs: ["E-001"],
      formula_ref: null,
      assumption_ref: null,
